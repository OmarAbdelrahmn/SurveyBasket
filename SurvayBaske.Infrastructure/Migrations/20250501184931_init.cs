        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_Polls_PollsId",
                        column: x => x.PollsId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "59724D2D-E2B5-4C67-AB6F-D93478347B03", 0, "B4555410-F5B0-45B1-B963-1B2351A0723C", "admin@survay-basket.com", true, "Survay Basket", false, "Admin", false, null, "ADMIN@SURVAY-BASKET.COM", "ADMIN@SURVAY-BASKET.COM", "AQAAAAIAAYagAAAAEMmY5Gper35rMmH0rLtCwbKNaaBKMx/A9BLMKB7bOxHg2q2x+mf1qXy72S2ZvXjDNw==", null, false, "9FABB58491024B7BB140E4D6658B5BDA", false, "admin@survay-basket.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_PollsId_Content",
                table: "Questions",
                columns: new[] { "PollsId", "Content" },
                unique: true);
